...
set(CLFFT_ROOT ${GEARSHIFFT_EXT_DIR}/clfft/ CACHE PATH "'clFFT' root directory")
...
if((NOT CLFFT_INCLUDE_DIR) OR (NOT EXISTS ${CLFFT_INCLUDE_DIR})
  ...
  message("'clfft' library could not be found, so [make] will download and build it (if OpenCL is available).")
  ...
  if(OpenCL_FOUND)
    ...
    ExternalProject_Add(clfft
      ...
      SOURCE_DIR ${GEARSHIFFT_EXT_SOURCE_DIR}/clfft
      SOURCE_SUBDIR src
      BINARY_DIR ${GEARSHIFFT_EXT_SOURCE_DIR}/clfft-build
      CMAKE_ARGS
