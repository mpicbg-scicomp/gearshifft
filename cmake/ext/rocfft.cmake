...
set(ROCFFT_ROOT ${GEARSHIFFT_SUPERBUILD_EXT_DIR}/rocfft/ CACHE PATH "'rocFFT' root directory (rocFFT depends on ROCM+HIP installation)")
...
elseif((NOT ROCFFT_INCLUDE_DIR) OR (NOT EXISTS ${ROCFFT_INCLUDE_DIR})
  ...
  ExternalProject_Add(rocfft
    ...
    UPDATE_COMMAND ""
    PATCH_COMMAND ""
    SOURCE_DIR ${GEARSHIFFT_SUPERBUILD_EXT_SOURCE_DIR}/rocFFT
    # SOURCE_SUBDIR library/src
    BINARY_DIR ${GEARSHIFFT_SUPERBUILD_EXT_SOURCE_DIR}/rocfft-build
    CMAKE_ARGS
