#ifndef GLOBALS_OPENCL_H_
#define GLOBALS_OPENCL_H_


#define clSafeCall( err ) __clSafeCall( err, __FILE__, __LINE__ )
#define clCheckError(err) __clSafeCall( err, __FILE__, __LINE__ )
