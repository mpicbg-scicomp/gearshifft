...
namespace gearshifft {
  namespace ClFFT {
    ...
    inline std::stringstream listClDevices() {
      ...
      for(cl_uint i=0; i<num_of_platforms; i++) {
        clGetDeviceIDs(platform_ids[i], CL_DEVICE_TYPE_ALL, 0, NULL, &num_of_devices);
    ...
    void getPlatformAndDeviceByID(cl_platform_id* platform_id,
      ...
      cl_uint num_of_devices = 0;
      clGetDeviceIDs(platform_ids[id_platform], CL_DEVICE_TYPE_ALL, 0, NULL, &num_of_devices);
